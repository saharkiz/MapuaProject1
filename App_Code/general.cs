...
public class general
{
    ...
    public static bool sendMail(String emailTo, String Subject, String Body,string titleemail)
    {
        ...
        //{
            try
            {
                MailAddress fromEmail = new MailAddress(ConfigurationManager.AppSettings.Get("fromEmail"), titleemail);              
                ...
                //smtp.Credentials = new System.Net.NetworkCredential("bigvglobal@gmail.com", "vbox.1111");
                //smtp.Port = 587;
                smtp.Send(message);
                return true;
            }
